...
from .models import Course, StudentCourse, CourseHold, TrainerAssignment, StudyMaterial, StudentFeedback
from .serializers import (
    CourseSerializer, StudentCourseSerializer, CourseHoldSerializer,
    TrainerAssignmentSerializer, StudyMaterialSerializer, StudentFeedbackSerializer,
...
class TrainerAssignmentViewSet(viewsets.ModelViewSet):
    ...
    def available_trainers_extended(self, request):
        ...
        if not start_time or not duration:
            return Response({"error": "Both start_time and duration are required."}, status=status.HTTP_400_BAD_REQUEST)
